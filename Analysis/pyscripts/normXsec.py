...
for i in range(0,len(th_xsec_164)):
    tot_xsec_164 += th_xsec_164[i]
    tot_xsec_162 += th_xsec_162[i]
    tot_xsec_166 += th_xsec_166[i]
    
print tot_xsec_164, tot_xsec_162, tot_xsec_166
...
for bin in range(1,5):
    g_th_164.SetPoint(bin-1, scales[bin-1], th_xsec_164[bin-1]/tot_xsec_164)
    g_th_164.SetPointError(bin-1,scales[bin-1]-bins[bin-1], bins[bin]-scales[bin-1], 0, 0)
    g_th_162.SetPoint(bin-1, scales[bin-1], th_xsec_162[bin-1]/tot_xsec_162)
    g_th_162.SetPointError(bin-1,scales[bin-1]-bins[bin-1], bins[bin]-scales[bin-1], 0, 0)
    g_th_166.SetPoint(bin-1, scales[bin-1], th_xsec_166[bin-1]/tot_xsec_166)
...
g_th_162.GetYaxis().SetTitle('#frac{1}{#sigma} #frac{d#sigma}{dm_{t#bar{t}}} #Deltam_{t#bar{t}}')
g_th_162.GetYaxis().SetTitleSize(0.05)
g_th_162.GetYaxis().SetTitleOffset(1.4)
...
latexLabel2.DrawLatex(0.87, 0.94, "13 TeV")
...
c.SaveAs('normXsec.png')
c.SaveAs('normXsec.pdf')
c.SaveAs('normXsec.root')
