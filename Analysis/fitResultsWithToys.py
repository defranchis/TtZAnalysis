...
histo_mod.SetTitle('pulls and constraints - modelling uncertainties')
histo_mod.SetMaximum(1.9)
histo_mod.SetMinimum(-1.9)
histo_mod.SetMarkerStyle(8)
histo_mod.SetMarkerColor(kBlue+1)
histo_mod.SetLineWidth(2)
histo_mod.SetLineColor(kBlue+1)

histo_stat_mod.SetTitle('pulls and constraints - modelling uncertainties')
histo_stat_mod.SetMaximum(1.9)
histo_stat_mod.SetMinimum(-1.9)
...
histo_central_mod.SetTitle('pulls and constraints - modelling uncertainties')
histo_central_mod.SetMaximum(1.9)
histo_central_mod.SetMinimum(-1.9)
