...
histo_stat_mod.SetLabelSize(.045)
...
histo_central_mod.SetLabelSize(.045)
...
latexLabel2.DrawLatex(0.15, 0.83, "modelling uncertainties")

leg = ROOT.TLegend(.45,.74,.895,.89)
leg.SetNColumns(2)
