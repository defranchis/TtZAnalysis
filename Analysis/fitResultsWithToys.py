...
c1.SetCanvasSize(850, c1.GetWh())
c1.SetLeftMargin(.09)
c1.SetRightMargin(.07)
c1.SetBottomMargin(.15)

histo_mod.SetTitle('')
histo_mod.GetYaxis().SetTitle()
histo_mod.SetMaximum(2.6)
histo_mod.SetMinimum(-2.6)
...
histo_stat_mod.GetYaxis().SetTitle()
histo_stat_mod.SetMaximum(2.6)
histo_stat_mod.SetMinimum(-2.6)
...
histo_stat_mod.SetLabelSize(.055)
histo_stat_mod.SetLabelOffset(.0115)

histo_central_mod.SetTitle('')
histo_central_mod.GetYaxis().SetTitle('Normalized pull')
histo_central_mod.GetYaxis().SetTitleSize(.045)
histo_central_mod.GetYaxis().SetTitleOffset(.65)
histo_central_mod.SetMaximum(2.6)
histo_central_mod.SetMinimum(-2.6)
...
histo_central_mod.SetLabelSize(.055)
histo_central_mod.SetLabelOffset(.0115)
...
latexLabel2.DrawLatex(0.15, 0.835, "Modelling uncertainties")

leg = ROOT.TLegend(.48,.74,.925,.89)
leg.SetNColumns(2)
leg.AddEntry(histo_mod,'Normalized pull','p')
leg.AddEntry(histo_mod,'Fit constraint','e')
leg.AddEntry(histo_stat_mod,'MC statistical','e')
leg.AddEntry(line_up_mod,'Pre-fit uncertainty','l')
leg.Draw('same')

c1.SaveAs('summaryPlotsToys/mod_fitSummary.pdf','pdf')
c1.SaveAs('summaryPlotsToys/mod_fitSummary.png','png')
c1.SaveAs('summaryPlotsToys/mod_fitSummary.root','root')
c1.Clear()
