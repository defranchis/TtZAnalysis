...
#ifndef ANALYSISPLOTSLOOSEKINRECO_H_
#define ANALYSISPLOTSLOOSEKINRECO_H_

#include "analysisPlots.h"

namespace ztop{

    class analysisPlotsLooseKinReco : public analysisPlots{
    public:
    analysisPlotsLooseKinReco(size_t step):analysisPlots(step),
            mtt(0),
            mtt_coarse(0),
            pt_ttbar(0),
            eta_ttbar(0),
  	...
  	~analysisPlotsLooseKinReco(){ /* destruction is handled in base class! */
	}
...
#endif /* ANALYSISPLOTSLOOSEKINRECO_H_ */
